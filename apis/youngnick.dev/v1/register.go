...
const (
	// GroupName is the group name for the DuckConditions types
	GroupName = "youngnick.dev"
)
...
var HTTPProxyGVR = GroupVersion.WithResource("duckconditions")

// Resource gets a GroupResource for a specified resource
